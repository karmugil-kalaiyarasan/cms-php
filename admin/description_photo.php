...
if( isset( $_FILES['photo'] ) )
{
  ...
  set_message( 'Description photo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Description photo has been deleted' );
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="description_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
